defmodule GSMLGDNS.ResourceOpt do
  @moduledoc """
  ...
  @doc """
  Converts a `GSMLGDNS.ResourceOpt` struct to a `:dns_rr_opt` record.
  """
  def to_record(%GSMLGDNS.ResourceOpt{unquote_splicing(pairs)}) do
    {:dns_rr_opt, unquote_splicing(vals)}
  end

  @doc """
  Converts a `:dns_rr_opt` record into a `GSMLGDNS.ResourceOpt`.
  """
  def from_record(dns_rr_opt)

  def from_record({:dns_rr_opt, unquote_splicing(vals)}) do
    %GSMLGDNS.ResourceOpt{unquote_splicing(pairs)}
  end
