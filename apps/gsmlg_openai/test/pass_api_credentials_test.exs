defmodule GSMLGOpenAI.PassApiKeyCredentialsTest do
  ...
  test "list models with env variable api key" do
    use_cassette "list_models_custom_key_env" do
      Application.put_env(:gsmlg_openai, :api_key, "abc_from_env")
      Application.put_env(:gsmlg_openai, :organization_key, "def_from_envxxxxx")

      {:error, res} = GSMLGOpenAI.Models.list_models()
      assert res["error"]["code"] == "invalid_api_key"
    end
  end
end
