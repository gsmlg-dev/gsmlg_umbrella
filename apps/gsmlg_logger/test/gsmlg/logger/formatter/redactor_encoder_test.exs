defmodule GSMLG.Logger.Formatter.RedactorEncoderTest do
  use GSMLG.Logger.Case, async: true
  use ExUnitProperties
  import GSMLG.Logger.Formatter.RedactorEncoder

  defmodule IDStruct, do: defstruct(id: nil)

  defmodule PasswordStruct, do: defstruct(password: "foo")

  @redactors [{GSMLG.Logger.Redactors.RedactKeys, ["password"]}]
  ...
  describe "encode/2" do
    ...
    test "inspects functions" do
      assert encode(&encode/2, []) == "&GSMLG.Logger.Formatter.RedactorEncoder.encode/2"
    end
