defmodule GSMLG.Logger.Formatters.DatadogTest do
  use GSMLG.Logger.Case
  use ExUnitProperties
  alias GSMLG.Logger.Formatters.Datadog
  require Logger
  ...
  test "logs throws" do
    ...
    assert %{
             ...
             "logger" => %{
               "file_name" => _file,
               "line" => _line,
               "method_name" => "Elixir.GSMLG.Logger.Formatters.DatadogTest." <> _,
               "thread_name" => _pid
             }
           } = log_entry
  end
  ...
  test "reads metadata from the given application env" do
    Application.put_env(:gsmlg_logger, :test_datadog_metadata_key, [:foo])
    formatter = {Datadog, metadata: {:from_application_env, {:gsmlg_logger, :test_datadog_metadata_key}}}
    :logger.update_handler_config(:default, :formatter, formatter)
  ...
  test "reads metadata from the given application env at given path" do
    Application.put_env(:gsmlg_logger, :test_datadog_metadata_key, metadata: [:foo])
    formatter = {Datadog, metadata: {:from_application_env, {:gsmlg_logger, :test_datadog_metadata_key}, [:metadata]}}
    :logger.update_handler_config(:default, :formatter, formatter)
