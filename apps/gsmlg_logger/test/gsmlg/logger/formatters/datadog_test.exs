defmodule GSMLG.Logger.Formatters.DatadogTest do
  ...
  test "reads metadata from the given application env" do
    ...
    formatter =
      {Datadog, metadata: {:from_application_env, {:gsmlg_logger, :test_datadog_metadata_key}}}
  ...
  test "reads metadata from the given application env at given path" do
    ...
    formatter =
      {Datadog,
       metadata: {:from_application_env, {:gsmlg_logger, :test_datadog_metadata_key}, [:metadata]}}
