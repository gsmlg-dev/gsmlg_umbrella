defmodule GSMLG.Logger.Formatters.ElasticTest do
  use GSMLG.Logger.Case
  use ExUnitProperties
  alias GSMLG.Logger.Formatters.Elastic
  require Logger
  ...
  test "logs message of every level" do
    for level <- [:error, :info, :debug, :emergency, :alert, :critical, :warning, :notice] do
      ...
      assert String.ends_with?(origin_file, "test/gsmlg/logger/formatters/elastic_test.exs")
