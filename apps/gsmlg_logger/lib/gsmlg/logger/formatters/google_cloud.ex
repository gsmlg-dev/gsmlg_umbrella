defmodule GSMLG.Logger.Formatters.GoogleCloud do
  @moduledoc """
  ...
  * `:service_context` (optional) - a map with the following keys:
  ...
  Regular message:
      ...
      %{
        ...
        "logging.googleapis.com/sourceLocation" => %{
          "file" => "/Users/andrew/Projects/os/gsmlg_logger/test/formatters/google_cloud_test.exs",
          "function" => "Elixir.GSMLG.Logger.Formatters.GoogleCloudTest.test logs an LogEntry of a given level/1",
          "line" => 44
        },
  ...
  Exception message that will be recognized by Google Cloud Error Reporting:
      ...
      %{
        ...
        "logging.googleapis.com/sourceLocation" => %{
          "file" => "/Users/andrew/Projects/os/gsmlg_logger/test/formatters/google_cloud_test.exs",
          "function" => "Elixir.GSMLG.Logger.Formatters.GoogleCloudTest.test logs exception http context/1",
          "line" => 301
        },
        ...
        "context" => %{
          ...
          "reportLocation" => %{
            "filePath" => "/Users/andrew/Projects/os/gsmlg_logger/test/formatters/google_cloud_test.exs",
            "functionName" => "Elixir.GSMLG.Logger.Formatters.GoogleCloudTest.test logs exception http context/1",
            "lineNumber" => 301
          }
        },
        "domain" => ["elixir"],
  ...
  import GSMLG.Logger.Formatter.{MapBuilder, DateTime, Message, Metadata, Code, RedactorEncoder}
