defmodule GSMLG.Logger.Formatters.Datadog do
  @moduledoc """
  ...
  * `:hostname` (optional) - changes how the `syslog.hostname` is set in logs. By default, it uses `:system` which uses
  ...
  ## Examples
      ...
      %{
        "domain" => ["elixir"],
        "logger" => %{
          "file_name" => "/Users/andrew/Projects/os/gsmlg_logger/test/formatters/datadog_test.exs",
          "line" => 44,
          "method_name" => "Elixir.GSMLG.Logger.Formatters.DatadogTest.test logs an LogEntry of a given level/1",
