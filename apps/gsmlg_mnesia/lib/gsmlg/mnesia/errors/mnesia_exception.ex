defmodule GSMLG.Mnesia.MnesiaException do
  alias __MODULE__

  # Don't raise this error manually, instead call `GSMLG.Mnesia.Error.normalize`
  # or `GSMLG.Mnesia.Error.raise_from` to raise these errors.
