defmodule GSMLGMnesia.MnesiaException do
  alias __MODULE__

  # Don't raise this error manually, instead call `GSMLGMnesia.Error.normalize`
  # or `GSMLGMnesia.Error.raise_from` to raise these errors.
