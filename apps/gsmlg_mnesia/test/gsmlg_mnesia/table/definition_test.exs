defmodule GSMLGMnesia.Tests.Table.Definition do
  ...
  describe "#struct_fields" do
    @expected [{:__meta__, GSMLGMnesia.Table} | @attrs]
  ...
  describe "#has_autoincrement?" do
    test "returns true for GSMLGMnesia Tables that have autoincrement" do
    ...
    test "returns false for GSMLGMnesia Tables that don't have autoincrement" do
      defmodule Meta.NoAutoIncrementUser do
        use GSMLGMnesia.Table, attributes: [:id, :full_name]
      end
