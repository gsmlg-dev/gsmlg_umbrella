defmodule Mix.Tasks.Gsmlg.Pki.Gen.Selfsigned do
  ...
  Generates a self-signed certificate for testing.
      ...
      mix gsmlg.pki.gen.selfsigned my-app my-app.local my-app.internal.example.com
  ...
  def certificate_and_key(key_size, name, hostnames) do
    ...
    certificate =
      GSMLG.PKI.Certificate.self_signed(
        ...
        template: :server,
        extensions: [
          subject_alt_name: GSMLG.PKI.Certificate.Extension.subject_alt_name(hostnames)
        ]
      )
