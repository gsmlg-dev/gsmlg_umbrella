defmodule GSMLG.PKI.CRL.Extension do
  @moduledoc """
  Convenience functions for creating `:Extension` records for use in
  CRLs or CRL entries.

  Some extensions defined in `GSMLG.PKI.Certificate.Extension` may also be used
  ...
  @opaque t :: GSMLG.PKI.ASN1.record(:extension)
  ...
  Example:
      ...
      iex> GSMLG.PKI.CRL.Extension.crl_number(12)
  ...
  Example:
      ...
      iex> GSMLG.PKI.CRL.Extension.reason_code(:keyCompromise)
