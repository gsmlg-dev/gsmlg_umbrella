defmodule GSMLG.PKI.CRL do
  ...
  alias GSMLG.PKI.{Certificate, SignatureAlgorithm}
  alias GSMLG.PKI.CRL.{Entry, Extension}

  @typedoc """
  `:CertificateList` record, as used in Erlang's `:public_key` module
  """
  @opaque t :: GSMLG.PKI.ASN1.record(:CertificateList)
  ...
  `GSMLG.PKI.CRL.Entry.new/3` to create a CRL entry for a given certificate.
  ...
  * `:extensions` - a keyword list of extension names and values; by default
  ...
  """
  # @doc since: "0.5.0"
  @spec new([Entry.t()], Certificate.t(), GSMLG.PKI.PrivateKey.t(), Keyword.t()) :: t()
  ...
  """
  # @doc since: "0.5.0"
  @spec valid?(t(), GSMLG.PKI.Certificate.t()) :: boolean()
  ...
  """
  # @doc since: "0.5.0"
  @spec list(t()) :: [GSMLG.PKI.CRL.Entry.t()]
  ...
  def this_update(certificate_list(tbsCertList: tbs)) do
    ...
    |> GSMLG.PKI.DateTime.to_datetime()
  end
  ...
  Processes the first PEM entry of type GSMLG.PKI CRL found in the input.
  """
  # @doc since: "0.5.0"
  ...
  Processes the first PEM entry of type GSMLG.PKI CRL found in the input. Returns an
  `:ok` tuple in case of success, or an `:error` tuple in case of failure.
  Possible error reasons are:

    * `:not_found` - no PEM entry of type GSMLG.PKI CRL was found
  ...
  defp update_aki(true, issuer) do
    case GSMLG.PKI.Certificate.extension(issuer, :subject_key_identifier) do
      nil ->
        false

      extension(extnValue: id) ->
        GSMLG.PKI.Certificate.Extension.authority_key_identifier(id)
    end
  end
  ...
  # Certificate extension generated by GSMLG.PKI.Certificate.Extension are intended
  ...
  defp encode_extension(extension(extnValue: record) = ext) when is_tuple(record) do
    ...
    GSMLG.PKI.ASN1.extension(ext, extnValue: der)
  end
end
