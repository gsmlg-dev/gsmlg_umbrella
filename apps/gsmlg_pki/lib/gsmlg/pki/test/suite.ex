defmodule GSMLG.PKI.Test.Suite do
  @moduledoc """
  ...
  * `client-cert` - requires that the client present a valid certificate
  ...
  @type t :: %__MODULE__{
          ...
          server_key: GSMLG.PKI.PrivateKey.t(),
          other_key: GSMLG.PKI.PrivateKey.t(),
          client_key: GSMLG.PKI.PrivateKey.t(),
          cacerts: [binary()],
          ...
          valid: GSMLG.PKI.Certificate.t(),
          wildcard: GSMLG.PKI.Certificate.t(),
          expired: GSMLG.PKI.Certificate.t(),
          revoked: GSMLG.PKI.Certificate.t(),
          selfsigned: GSMLG.PKI.Certificate.t(),
          client: GSMLG.PKI.Certificate.t(),
          crls: %{String.t() => GSMLG.PKI.CRL.t()}
        }
  ...
  * `:key_type` - the type of private keys to generate; may be set to `{:rsa,
  ...
  def new(opts \\ []) do
    ...
    # CA certificates
    root_ca =
      GSMLG.PKI.Certificate.self_signed(root_ca_key, "/O=#{__MODULE__}/CN=Root CA",
        template: :root_ca
      )
    ...
    intermediate_ca =
      ...
      |> GSMLG.PKI.Certificate.new("/O=#{__MODULE__}/CN=Intermediate CA", root_ca, root_ca_key,
        template: :ca,
    ...
    expired_int_ca =
      ...
      |> GSMLG.PKI.Certificate.new("/O=#{__MODULE__}/CN=Intermediate CA", root_ca, root_ca_key,
        template: :ca,
        validity: GSMLG.PKI.Certificate.Validity.days_from_now(-1, 30 * @seconds_per_day),
        extensions: crl_extensions(crl_server, "root_ca.crl")
      )
    ...
    cross_signer_root_ca =
      GSMLG.PKI.Certificate.self_signed(
        ...
        extensions: [
          ...
          basic_constraints: GSMLG.PKI.Certificate.Extension.basic_constraints(true, 2)
        ]
      )
      ...
      |> GSMLG.PKI.Certificate.new(
        ...
        extensions:
          [
            ...
            basic_constraints: GSMLG.PKI.Certificate.Extension.basic_constraints(true, 1)
    ...
    crls =
      if is_nil(crl_server) do
        ...
        root_crl_entry =
          GSMLG.PKI.CRL.Entry.new(revoked_int_ca, DateTime.utc_now(), [
            GSMLG.PKI.CRL.Extension.reason_code(:superseded)
          ])

        root_crl =
          GSMLG.PKI.CRL.new([root_crl_entry], root_ca, root_ca_key,
            extensions: [crl_number: GSMLG.PKI.CRL.Extension.crl_number(299)]
          )

        cross_signer_root_crl =
          GSMLG.PKI.CRL.new([], cross_signer_root_ca, cross_signer_root_ca_key,
            extensions: [crl_number: GSMLG.PKI.CRL.Extension.crl_number(399)]
          )

        intermediate_ca_crl_entry =
          GSMLG.PKI.CRL.Entry.new(revoked, DateTime.utc_now(), [
            GSMLG.PKI.CRL.Extension.reason_code(:keyCompromise)
          ])

        intermediate_ca_crl =
          GSMLG.PKI.CRL.new([intermediate_ca_crl_entry], intermediate_ca, intermediate_ca_key,
            extensions: [crl_number: GSMLG.PKI.CRL.Extension.crl_number(199)]
          )
    ...
    %__MODULE__{
      ...
      cacerts: [GSMLG.PKI.Certificate.to_der(root_ca)],
      alternate_cacerts: [GSMLG.PKI.Certificate.to_der(cross_signer_root_ca)],
      chain: [GSMLG.PKI.Certificate.to_der(intermediate_ca)],
      expired_chain: [GSMLG.PKI.Certificate.to_der(expired_int_ca)],
      revoked_chain: [GSMLG.PKI.Certificate.to_der(revoked_int_ca)],
      alternate_chain: [
        GSMLG.PKI.Certificate.to_der(intermediate_ca),
        GSMLG.PKI.Certificate.to_der(cross_signed_ca)
      ],
      valid: valid,
      wildcard: wildcard,
      expired: expired,
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(valid),
      cacerts: chain,
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(server_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(valid),
      cacerts: chain,
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(other_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(wildcard),
      cacerts: chain,
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(server_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(expired),
      cacerts: chain,
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(server_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(revoked),
      cacerts: chain,
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(server_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    [
      cert: GSMLG.PKI.Certificate.to_der(selfsigned),
      key: {:PrivateKeyInfo, GSMLG.PKI.PrivateKey.to_der(server_key, wrap: true)}
    ]
  end
  ...
  def sni_handler(
    ...
    GSMLG.PKI.Logger.warn("Unknown scenario: #{scenario}")
  ...
  defp new_key({:rsa, length}) do
    GSMLG.PKI.PrivateKey.new_rsa(length)
  end

  defp new_key({:ec, curve}) do
    GSMLG.PKI.PrivateKey.new_ec(curve)
  end
end
