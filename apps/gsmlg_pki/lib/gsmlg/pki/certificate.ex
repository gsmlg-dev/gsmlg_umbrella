defmodule GSMLG.PKI.Certificate do
  @moduledoc """
  ...
  import GSMLG.PKI.ASN1, except: [extension: 2]

  alias GSMLG.PKI.{PublicKey, RDNSequence, SignatureAlgorithm}
  alias GSMLG.PKI.Certificate.{Template, Validity, Extension}

  @typedoc """
  `:OTPCertificate` record , as used in Erlang's `:public_key` module
  """
  @type t :: GSMLG.PKI.ASN1.record(:otp_certificate)
  ...
  `GSMLG.PKI.RDNSequence.new/1`, or a custom RDN sequence tuple.
  ...
  * `:template` - an `GSMLG.PKI.Certificate.Template` struct, or an atom selecting
  ...
  * `:validity` - an integer specifying the certificate's validity in days,
    or an `GSMLG.PKI.Certificate.Validity` record defining the 'not before' and
  ...
  * `:extensions` - a keyword list of extension names and values, to be merged
    ...
    `GSMLG.PKI.Certificate.Template` documentation for details
  """
  @spec new(
          GSMLG.PKI.PublicKey.t(),
          String.t() | GSMLG.PKI.RDNSequence.t(),
          t(),
          GSMLG.PKI.PrivateKey.t(),
          Keyword.t()
        ) :: t()
  ...
  The Subject can be specified as a string, to be parsed by
  `GSMLG.PKI.RDNSequence.new/1`, or a custom RDN sequence tuple. The same value is
  ...
  * `:extensions` - a keyword list of extension names and values, to be merged
  ...
  """
  @spec subject(t()) :: GSMLG.PKI.RDNSequence.t()
  ...
  See also `GSMLG.PKI.RDNSequence.get_attr/2`.
  """
  @spec subject(t(), binary() | :public_key.oid()) :: [String.t()]
  def subject(cert, attr_type) do
    cert
    |> subject()
    |> GSMLG.PKI.RDNSequence.get_attr(attr_type)
  end

  @doc """
  Returns the Issuer field of a certificate.
  """
  @spec issuer(t()) :: GSMLG.PKI.RDNSequence.t()
  ...
  """
  @spec validity(t()) :: GSMLG.PKI.Certificate.Validity.t()
  ...
  """
  @spec public_key(t()) :: GSMLG.PKI.PublicKey.t()
  ...
  """
  @spec extensions(t()) :: [GSMLG.PKI.Certificate.Extension.t()]
  ...
  """
  @spec extension(t(), GSMLG.PKI.Certificate.Extension.extension_id() | :public_key.oid()) ::
          GSMLG.PKI.Certificate.Extension.t() | nil
    ...
    aki =
      case extension(issuer, oid(:"id-ce-subjectKeyIdentifier")) do
        ...
        plain_ski ->
          ...
          plain_ski
          |> :pubkey_cert_records.transform(:decode)
          |> GSMLG.PKI.ASN1.extension(:extnValue)
      end
