defmodule GSMLG.PKI.PrivateKey do
  ...
  Encryption and decryption:
      ...
      iex> private_key = GSMLG.PKI.PrivateKey.new_rsa(2048)
      iex> public_key = GSMLG.PKI.PublicKey.derive(private_key)
  ...
  Signing and signature verification:
      ...
      iex> private_key = GSMLG.PKI.PrivateKey.new_ec(:secp256r1)
      iex> public_key = GSMLG.PKI.PublicKey.derive(private_key)
  ...
  """
  @spec wrap(t()) :: GSMLG.PKI.ASN.record(:private_key_info)
  ...
  """
  @spec wrap(GSMLG.PKI.ASN.record(:private_key_info)) :: t()
  def unwrap(
  ...
  def from_der(der) do
    case GSMLG.PKI.try_der_decode(der, @private_key_records) do
      nil ->
        {:error, :malformed}
