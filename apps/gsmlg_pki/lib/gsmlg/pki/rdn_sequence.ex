defmodule GSMLG.PKI.RDNSequence do
  @moduledoc """
  ...
  * emailAddress (E)
  ...
  The optional second parameter can be used to select the output format:
    ...
    * `:plain` - for use in `:Certificate` and `:CertificationRequest` records
      (default)
    * `:otp` - for use in `:OTPCertificate` records (see `GSMLG.PKI.Certificate`)
  ...
  ## Examples:
      ...
      iex> GSMLG.PKI.RDNSequence.new("/C=US/CN=Bob")
      {:rdnSequence,
       [
      ...
      iex> GSMLG.PKI.RDNSequence.new("C=CN, givenName=麗")
      {:rdnSequence,
       [
      ...
      iex> GSMLG.PKI.RDNSequence.new(commonName: "Elixir")
      {:rdnSequence,
       [
         [{:AttributeTypeAndValue, {2, 5, 4, 3}, <<12, 6, 69, 108, 105, 120, 105, 114>>}]
       ]}

      iex> GSMLG.PKI.RDNSequence.new(language: "Elixir")
      ** (FunctionClauseError) no function clause matching in GSMLG.PKI.RDNSequence.new_attr/1

      iex> GSMLG.PKI.RDNSequence.new("C=!!")
  ...
  ## Examples:
      ...
      iex> GSMLG.PKI.RDNSequence.new("C=CN, givenName=麗") |> GSMLG.PKI.RDNSequence.to_string
      "/C=CN/GN=麗"
  """
  ...
  ## Examples:
      ...
      iex> GSMLG.PKI.RDNSequence.new("/C=US/CN=Bob") |> GSMLG.PKI.RDNSequence.get_attr(:countryName)
      ["US"]
      iex> GSMLG.PKI.RDNSequence.new("/C=US/CN=Bob") |> GSMLG.PKI.RDNSequence.get_attr("commonName")
      ["Bob"]
      iex> GSMLG.PKI.RDNSequence.new("C=CN, givenName=麗") |> GSMLG.PKI.RDNSequence.get_attr("GN")
      ["麗"]
  """
