defmodule GSMLG.PKI.Certificate.Validity do
  @moduledoc """
  ...
  @type t :: GSMLG.PKI.ASN1.record(:validity)
  ...
  ## Examples:
      ...
      iex> GSMLG.PKI.Certificate.Validity.new(not_before, not_after)
  ...
  def new(%DateTime{} = not_before, %DateTime{} = not_after) do
    validity(
      notBefore: GSMLG.PKI.DateTime.new(not_before),
      notAfter: GSMLG.PKI.DateTime.new(not_after)
    )
  end
  ...
  def days_from_now(days, backdate_seconds \\ @default_backdate_seconds) do
    validity(
      notBefore: GSMLG.PKI.DateTime.new(-backdate_seconds),
      notAfter: GSMLG.PKI.DateTime.new(days * @seconds_per_day)
    )
  end
end
