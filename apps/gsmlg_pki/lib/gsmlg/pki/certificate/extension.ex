defmodule GSMLG.PKI.Certificate.Extension do
  @moduledoc """
  Convenience functions for creating `:Extension` records for use in
  certificates.
  """

  import GSMLG.PKI.ASN1, except: [basic_constraints: 2, authority_key_identifier: 1]

  alias GSMLG.PKI.Util

  @typedoc "`:Extension` record, as used in Erlang's `:public_key` module"
  @type t :: GSMLG.PKI.ASN1.record(:extension)
  ...
  Examples:
      ...
      iex> GSMLG.PKI.Certificate.Extension.basic_constraints(false)
      {:Extension, {2, 5, 29, 19}, false,
       {:BasicConstraints, false, :asn1_NOVALUE}}

      iex> GSMLG.PKI.Certificate.Extension.basic_constraints(true)
      {:Extension, {2, 5, 29, 19}, true, {:BasicConstraints, true, :asn1_NOVALUE}}

      iex> GSMLG.PKI.Certificate.Extension.basic_constraints(true, 0)
  ...
  def basic_constraints(false, :asn1_NOVALUE) do
    extension(
      ...
      critical: false,
      extnValue: GSMLG.PKI.ASN1.basic_constraints(cA: false, pathLenConstraint: :asn1_NOVALUE)
    )
  end
  ...
  def basic_constraints(true, path_len_constraint) do
    extension(
      ...
      critical: true,
      extnValue:
        GSMLG.PKI.ASN1.basic_constraints(cA: true, pathLenConstraint: path_len_constraint)
    )
  end
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.key_usage([:digitalSignature, :keyEncipherment])
  ...
  * `:ocspSigning` - Signing OCSP responses
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.ext_key_usage([:serverAuth, :clientAuth])
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.subject_key_identifier({:RSAPublicKey, 55, 3})
      {:Extension, {2, 5, 29, 14}, false,
       <<187, 230, 143, 92, 27, 37, 166, 93, 176, 137, 154, 111, 62, 152,
        215, 114, 3, 214, 71, 170>>}
  """
  @spec subject_key_identifier(GSMLG.PKI.PublicKey.t() | binary()) :: t()
  def subject_key_identifier(rsa_public_key() = public_key) do
    :crypto.hash(:sha, GSMLG.PKI.PublicKey.to_der(public_key))
    |> subject_key_identifier()
  end
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.authority_key_identifier({:RSAPublicKey, 55, 3})
      {:Extension, {2, 5, 29, 35}, false,
       {:AuthorityKeyIdentifier,
        <<187, 230, 143, 92, 27, 37, 166, 93, 176, 137, 154, 111, 62, 152,
         215, 114, 3, 214, 71, 170>>, :asn1_NOVALUE, :asn1_NOVALUE}}
  """
  @spec authority_key_identifier(GSMLG.PKI.PublicKey.t() | binary()) :: t()
  ...
  def authority_key_identifier(id) when is_binary(id) do
    extension(
      ...
      critical: false,
      extnValue: GSMLG.PKI.ASN1.authority_key_identifier(keyIdentifier: id)
    )
  end
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.subject_alt_name(["www.example.com", "example.com"])
      {:Extension, {2, 5, 29, 17}, false,
       [dNSName: ~c"www.example.com", dNSName: ~c"example.com"]}

      iex> GSMLG.PKI.Certificate.Extension.subject_alt_name(emailAddress: ~c"user@example.com")
      {:Extension, {2, 5, 29, 17}, false,
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.crl_distribution_points(["http://crl.example.org/root.crl"])
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.authority_info_access(
  ...
  Example:
      ...
      iex> GSMLG.PKI.Certificate.Extension.ocsp_nocheck()
