defmodule GSMLG.PKI.Certificate.Template do
  @moduledoc """
  Certificate templates.
  """

  import GSMLG.PKI.Certificate.Extension

  defstruct serial: {:random, 8}, validity: 365, hash: :sha256, extensions: []

  @type t :: %__MODULE__{
          serial: pos_integer() | {:random, pos_integer()},
          validity: pos_integer() | GSMLG.PKI.Certificate.Validity.t(),
          hash: atom(),
          extensions: [{atom(), GSMLG.PKI.Certificate.Extension.t() | boolean()}]
        }
  ...
  `GSMLG.PKI.Certificate.Extension` record. The `subject_key_identifier` and
  ...
  ## Options:
    ...
    * `:validity` - override the validity period; can be specified as the
      number of days (integer) or a `GSMLG.PKI.Certificate.Validity` value
  ...
  ## Examples:
      ...
      iex> GSMLG.PKI.Certificate.Template.new(:root_ca,
      ...>   hash: :sha512, serial: 1,
      ...>   extensions: [authority_key_identifier: false]
      ...> )
      %GSMLG.PKI.Certificate.Template{
        extensions: [
      ...
      iex> GSMLG.PKI.Certificate.Template.new(:server, extensions: [
      ...>   ext_key_usage: GSMLG.PKI.Certificate.Extension.ext_key_usage([:codeSigning])
      ...> ])
      %GSMLG.PKI.Certificate.Template{
        extensions: [
