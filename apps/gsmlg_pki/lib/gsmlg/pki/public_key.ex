defmodule GSMLG.PKI.PublicKey do
  ...
  @type spki ::
          GSMLG.PKI.ASN.record(:subject_public_key_info)
          | GSMLG.PKI.ASN.record(:otp_subject_public_key_info)
          | GSMLG.PKI.ASN.record(:certification_request_subject_pk_info)
  ...
  for all key types.
  """
  @spec derive(GSMLG.PKI.PrivateKey.t() | :crypto.engine_key_ref()) :: t()
  ...
  def from_der(der) do
    case GSMLG.PKI.try_der_decode(der, @public_key_records) do
      nil ->
        {:error, :malformed}
