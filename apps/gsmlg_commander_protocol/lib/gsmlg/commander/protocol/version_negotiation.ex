defmodule GSMLG.Commander.Protocol.VersionNegotiation do
  @moduledoc "Protocol version and capability advertisement."
  ...
  def encode(%__MODULE__{} = negotiation) do
    with {:ok, capabilities} <- encode_capabilities(negotiation.capabilities) do
      map = %{
