defmodule GSMLG.IpGeo do
  ...
  ## Usage
      ...
      # Lookup an IP address (uses default city database)
      GSMLG.IpGeo.lookup("8.8.8.8")
      # => {:ok, %{city: "Mountain View", country: "United States", country_code: "US", ...}}

      # Lookup with specific database
      GSMLG.IpGeo.lookup("8.8.8.8", :city)

      # Get just the country
      GSMLG.IpGeo.country("8.8.8.8")
      # => {:ok, "United States"}

      # Get the city
      GSMLG.IpGeo.city("8.8.8.8")
      # => {:ok, "Mountain View"}
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.lookup("8.8.8.8")
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.country("8.8.8.8")
      {:ok, "United States"}
  """
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.country_code("8.8.8.8")
      {:ok, "US"}
  """
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.coordinates("8.8.8.8")
      {:ok, {37.386, -122.0838}}
  """
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.list_databases()
      [:city, :country]
  """
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.database_info(:city)
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.load_database(:custom, "/path/to/custom.mmdb")
      :ok
  """
  ...
  ## Examples
      ...
      iex> countries = GSMLG.IpGeo.list_countries()
  ...
  defdelegate list_countries, to: GSMLG.IpGeo.Countries, as: :list
  ...
  ## Examples
      ...
      iex> GSMLG.IpGeo.search_countries("united")
      [%{code: "AE", name: "United Arab Emirates"}, ...]
  """
  @spec search_countries(String.t()) :: [%{code: String.t(), name: String.t()}]
  defdelegate search_countries(query), to: GSMLG.IpGeo.Countries, as: :search
