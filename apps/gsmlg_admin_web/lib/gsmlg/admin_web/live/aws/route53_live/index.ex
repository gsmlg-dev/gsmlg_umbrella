defmodule GSMLG.AdminWeb.Route53Live.Index do
  use GSMLG.AdminWeb, :aws_live_view
  ...
  def handle_event("add_record", %{"record" => rr, "hosted_zone_id" => hosted_zone_id}, socket) do
    ...
    socket =
      case Route53.change_resource_record_sets(hosted_zone_id, req_input) do
        :ok ->
          socket
