defmodule GSMLG.AdminWeb.Schema do
  use Absinthe.Schema
  import_types(Absinthe.Plug.Types)
  import_types(GSMLG.AdminWeb.Schema.ContentTypes)
  import_types(GSMLG.AdminWeb.Schema.NodeTypes)
  import_types(GSMLG.AdminWeb.Schema.ChessTypes)

  alias GSMLG.AdminWeb.Resolvers
