defmodule GSMLGAdminWeb.Schema do
  use Absinthe.Schema
  import_types(Absinthe.Plug.Types)
  import_types(GSMLGAdminWeb.Schema.ContentTypes)
  import_types(GSMLGAdminWeb.Schema.NodeTypes)
  import_types(GSMLGAdminWeb.Schema.ChessTypes)

  alias GSMLGAdminWeb.Resolvers
